...
import { languageCurrencyMap } from '../types/locale.ts'
import { isLoginError } from '../utils/checkLogin.ts'
import {
  wepinSdkInstance,
  wepinLoginInstance,
  wepinProviderInstance,
} from '../wepinInstances.ts'
...
export const WepinSDKContext: React.FC<{ children: React.ReactNode }> = ({
  children,
}) => {
