import type { ResponseUserInfo, ResponseResetPassword, ResponseVerifyEmail, ResponseSignUp, ResponseSignInWithPassword, ResponseUpdatePassword } from '../../types/firebaseAuthAPI.js';
import type { FirebaseAPI } from './IAPI.js';
