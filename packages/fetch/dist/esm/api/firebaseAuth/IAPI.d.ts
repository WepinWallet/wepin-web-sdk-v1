import type { ResponseResetPassword, ResponseSignInWithPassword, ResponseSignUp, ResponseUpdatePassword, ResponseUserInfo, ResponseVerifyEmail } from '../../types/firebaseAuthAPI.js';
